# **CUrbanized Area Peer Communities for Coordinated Human Services Plan Update**
...
Part of the responsibility of a Metropolitan Planning Organization like the Greater Nashville Regional Council is updating the Coordinated Public Transit - Human Services Transportation Plan for the Nashville Area and Clarksville Urbanized Area. Find the previous 2016 plan <a href="https://www.gnrc.org/DocumentCenter/View/1034/Coordinated-Human-Services-Transportation-2016">here</a>. This analysis explores peer communities for the region using a K-Means Clustering algorithm. The input variables are intended to tailor results to peer regions that are comprable in population, population density, share of senior and disabled population, availability of healthcare facilities, availability of highways, share of urban vs. rural populations, and proximity to adjacent metropolitan areas.

## Data Prep  

PLACEHOLDER using the Census API from the American Community Survey 5-Year Estimates:

+ B01003_001E: PLACEHOLDER
+ B25010_001E: PLACEHOLDER
+ B08301_001E: PLACEHOLDER
+ S0801_C01_046E: PLACEHOLDER
